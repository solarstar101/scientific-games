...
export const drawApiRecent = createApi({
    ...
    baseQuery: fetchBaseQuery({
        baseUrl: 'https://puertorico.secondchancebonuszone.com/kino/past_drawings.php',
...
export const { useSingleRecentDrawQuery,usePastDrawsStartingPointQuery }: any = drawApiRecent
